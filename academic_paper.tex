...
\item \textbf{structured\_extended} (planned): adds additional atoms (e.g., $r_{ij}/d_{ij}^2$, velocity differences, gated cross terms) to search for simpler regime-specific approximations beyond the baseline.
\end{itemize}
