...
At the end of a run, we additionally render a reproducible evaluation artifact (Markdown and LaTeX) that records the best discovered equations (exact text), the best-run initial conditions, and a best-vs-history comparison over prior local attempts.
